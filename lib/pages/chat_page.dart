...
class _ChatPageState extends State<ChatPage> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    this.chatService = Provider.of<ChatService>(context,
        listen:
            false); //Jamas en un init se va a redibujar es decir no se utiloza el listen: true, a menos que se encuentre en un callback
    this.socketService = Provider.of<SocketService>(context, listen: false);
    this.authService = Provider.of<AuthService>(context, listen: false);

    //Evento para escuchar  cuando el servidor emite
  ...
  void _cargarHistorial(String usuarioID) async {
    ...
    final history = chat.map((m) => ChatMessage(
        ...
        animationController: new AnimationController(
          ...
          ..forward() //inmediatamente va a lansar esto
        ));
...
//emitir los mensajes al servidor
